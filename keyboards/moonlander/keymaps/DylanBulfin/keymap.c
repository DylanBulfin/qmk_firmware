...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, MT(MOD_LALT, KC_A),MT(MOD_LGUI, KC_R),MT(MOD_LCTL, KC_S),MT(MOD_LSFT, KC_T),KC_G,           KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_M,           MT(MOD_LSFT, KC_N),MT(MOD_LCTL, KC_E),MT(MOD_LGUI, KC_I),MT(MOD_LALT, KC_O),KC_QUOTE,       
    KC_LEFT_SHIFT,  KC_Z,           KC_X,           KC_C,           KC_D,           KC_V,                                           KC_K,           KC_H,           KC_COMMA,       KC_DOT,         KC_SLASH,       KC_TRANSPARENT, 
    TG(5),          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_ALT,    KC_LEFT_GUI,                                                                                                    KC_LEFT_ALT,    KC_LEFT_CTRL,   KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_BSPC,        LT(3,KC_ENTER), KC_TRANSPARENT,                 LT(4,KC_ESCAPE),LT(2,KC_TAB),   LT(1,KC_SPACE)
  ),
  [1] = LAYOUT_moonlander(
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, RGB_VAI,                                        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          RGB_VAD,                                        KC_TRANSPARENT, KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_LEFT_ALT,    KC_LEFT_GUI,    KC_LEFT_CTRL,   KC_LEFT_SHIFT,  KC_NO,          RGB_TOG,                                                                        KC_TRANSPARENT, KC_LEFT,        KC_DOWN,        KC_UP,          KC_RIGHT,       KC_NO,          KC_TRANSPARENT, 
  ...
  [2] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_LPRN,        KC_4,           KC_5,           KC_6,           KC_RPRN,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_SHIFT,  KC_LEFT_CTRL,   KC_LEFT_GUI,    KC_LEFT_ALT,    KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_LBRC,        KC_1,           KC_2,           KC_3,           KC_RBRC,                                        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [3] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_EQUAL,       KC_DLR,         KC_PERC,        KC_CIRC,        KC_PLUS,        KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_SHIFT,  KC_LEFT_CTRL,   KC_LEFT_GUI,    KC_LEFT_ALT,    KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_MINUS,       KC_EXLM,        KC_AT,          KC_HASH,        KC_UNDS,                                        KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
  ...
  [4] = LAYOUT_moonlander(
    ...
    KC_TRANSPARENT, KC_F11,         KC_F4,          KC_F5,          KC_F6,          KC_NO,          KC_TRANSPARENT,                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_SHIFT,  KC_LEFT_CTRL,   KC_LEFT_GUI,    KC_LEFT_ALT,    KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_F10,         KC_F1,          KC_F2,          KC_F3,          KC_NO,                                          KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                                                                                                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, 
    KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT,                 KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT
  ),
  [5] = LAYOUT_moonlander(
...
const uint8_t PROGMEM ledmap[][RGB_MATRIX_LED_COUNT][3] = {
    ...
    [3] = { {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255}, {212,230,255} },

    [4] = { {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201}, {139,230,201} },

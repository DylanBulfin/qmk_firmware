...
/*extern uint16_t achordion_timeout(uint16_t tap_hold_keycode);*/
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_moonlander(KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TAB, KC_Q, KC_W, KC_F, KC_P, KC_B, KC_TRANSPARENT, KC_TRANSPARENT, KC_J, KC_L, KC_U, KC_Y, KC_SCLN, KC_TRANSPARENT, KC_LEFT_CTRL, MT(MOD_LALT, KC_A), MT(MOD_LGUI, KC_R), MT(MOD_LCTL, KC_S), MT(MOD_LSFT, KC_T), KC_G, KC_TRANSPARENT, KC_TRANSPARENT, KC_M, MT(MOD_LSFT, KC_N), MT(MOD_LCTL, KC_E), MT(MOD_LGUI, KC_I), MT(MOD_LALT, KC_O), KC_QUOTE, KC_LEFT_SHIFT, KC_Z, KC_X, KC_C, KC_D, KC_V, KC_K, KC_H, KC_COMMA, KC_DOT, KC_SLASH, KC_TRANSPARENT, TG(5), KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_LEFT_ALT, KC_LEFT_GUI, KC_LEFT_ALT, KC_LEFT_CTRL, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, KC_TRANSPARENT, LT(2, KC_BSPC), LT(3, KC_ENTER), KC_LGUI, MT(MOD_LSFT, KC_ESC), LT(4, KC_TAB), LT(1, KC_SPACE)),
